...
public class OtpGen {
    ...
    public static void main(String[] args) {
        ...
        try {
            String number = generateNumberString(secretKey, System.currentTimeMillis(), 30);
    ...
    // Following code from newwork, thanks for the author
    ...
    /**
     * Generate and return a 16-character secret key in base32 format (A-Z2-7) using {@link java.security.SecureRandom}. Could be used
